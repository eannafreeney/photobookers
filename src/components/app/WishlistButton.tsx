...
const WishlistButton = async ({
  ...
  const buttonIcon = isWishlisted ? fullHeartIcon : emptyHeartIcon;
  isWishlisted ? fullHeartIcon : emptyHeartIcon;
...
const emptyHeartIcon = (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    x-bind:class="{ 'text-red-500': isLoading }"
...
const fullHeartIcon = (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    x-bind:class="{ 'text-blue-500': isLoading }"
