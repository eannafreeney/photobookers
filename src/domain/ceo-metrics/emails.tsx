...
import type { CeoMetricsSnapshot } from "./types";
...
function metricRow(label: string, value: number, deltaLabel: string): string {
  return `<tr>
...
function snapshotRow(label: string, value: number): string {
  return `<tr>
