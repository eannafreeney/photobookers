...
import { runBotdAdvanceNotificationEmailsCron } from "@/jobs/cronRunners";
import { parseDateString } from "../../../lib/utils";
import { requireCronSecret } from "@/jobs/cronRouteAuth";

/** Prefer GitHub Actions: npx tsx scripts/cron/run.ts botd-advance-notification-emails */
export const POST = createRoute(async (c: Context) => {
  ...
  if (dateParam) {
    ...
    const [error, result] = await runBotdAdvanceNotificationEmailsCron({ date });
