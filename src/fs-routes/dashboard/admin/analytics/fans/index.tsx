...
import FansTable from "../../../../../features/dashboard/admin/analytics/components/FansTable";
...
export const GET = createRoute(async (c) => {
  ...
  return c.html(
    <AppLayout title="Fans" user={user} currentPath={currentPath}>
      <Page>
        <Sidebar currentPath={currentPath}>
          <div class="flex flex-col gap-6">
            ...
            <FansTable currentPage={currentPage} currentPath={paginationBaseUrl} />
          </div>
        </Sidebar>
      </Page>
    </AppLayout>,
