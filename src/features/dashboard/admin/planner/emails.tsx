export const generateBOTDNotificationEmail = (
  ...
  <p>Great news - your book, <strong>${book.title}</strong>, has been selected as <strong>Book of the Day</strong> on Photobookers.</p>
  <p>Your feature is now live here: <a href="${process.env.SITE_URL ?? "https://photobookers.com"}/book-of-the-day">View Book of the Day</a>.</p>
