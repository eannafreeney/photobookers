...
const SERIES = [
  { key: "sessions" as const, label: "Sessions", color: "#1d4ed8" },
  { key: "totalUsers" as const, label: "Users", color: "#047857" },
];

const SiteTrafficTrendSection = ({ data, dateRange }: Props) => {
...
const ChartBlock = <T extends { date: string }>({
  ...
  return (
    <div class="flex flex-col gap-4">
      ...
      {points.length === 0 ? (
        <p class="text-sm text-on-surface">No traffic data for this period.</p>
      ) : (
...
export default SiteTrafficTrendSection;
