...
const RegisterFanForm = ({ redirectUrl }) => {
  const alpineAttrs = {
  ...
  const action = redirectUrl ? `/auth/register-fan?redirectUrl=${redirectUrl}` : "/auth/register-fan";
...
var RegisterFanForm_default = RegisterFanForm;
export {
  RegisterFanForm_default as default
};
