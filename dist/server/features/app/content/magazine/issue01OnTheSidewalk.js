...
const issue01EssaySections = [
  ...
  },
  {
    ...
    paragraphs: [
      "The street's grammar travels. Pants on Top of Shoes finds Tbilisi's sidewalks marked by post-Soviet texture \u2014 humor and wear in the same frame, the body slightly absurd against architecture that does not apologize. D\xE9rive #1 applies psychogeographic drift to Mannheim: not the landmark city but the immigrant's second home, Wahlheimat, chosen rather than inherited.",
...
const issue01BookEntries = [
  {
    slug: "sidewalks-adam-mcewen",
    blurb: "London's pavement as abstract field: stains, gum, marks of passage. People are absent but implied; the edit is restrained, almost clinical. A reminder that street work need not chase the decisive human moment \u2014 sometimes the ground holds the memory.",
    artistPrompt: "What on the sidewalk do people step over without seeing?"
  },
  {
    slug: "hong-kong-parr-martin-parr",
    blurb: "Parr in Hong Kong is color as noise \u2014 food, tourism, consumption, faces that meet the lens head-on. Less observation than collision; the book thrives on the city's appetite for being looked at."
  },
  {
    slug: "pay-phone-daniel-weiss",
    blurb: "New York pay phones as ruins in plain sight. Weiss slows down a city that usually refuses stillness; obsolescence becomes portrait.",
    artistPrompt: "What public object in your city has outlived its original purpose?"
  },
  {
    slug: "play-space-north-kensington-19671969-adam-ritchie",
    blurb: "An adventure playground in North Kensington: children building worlds from scrap and permission. Street photography as sustained presence, not single theft."
  },
  {
    slug: "soho-north-east-london-1980s1990s-2-books-tony-kearns",
    blurb: "Two Londons \u2014 Soho's night economy and east London's shifting edges \u2014 in one archival sweep. The sidewalk after dark as workplace and theater."
  },
  {
    slug: "mixed-messages-paul-treacy",
    blurb: "Signs, slogans, masks, demonstrations: the street as reader and speaker. Treacy collects public language at the moment before it dissolves back into foot traffic."
  },
  {
    slug: "pants-on-top-of-shoes-ivan-anisimov",
    blurb: "Tbilisi sidewalks with post-Soviet wit \u2014 bodies slightly wrong against the city, humor without softening."
  },
  {
    slug: "derive-1-monnem-wahlheimat-sandra-koestler",
    blurb: "Psychogeographic drift in Mannheim; Wahlheimat \u2014 chosen homeland \u2014 as method. The street navigated by memory and displacement, not map."
  },
  {
    slug: "la-polaroids-robby-muller",
    blurb: "The cinematographer's Los Angeles in Polaroid: parking lots, palms, the epic in the incidental. Instant film as sidewalk \u2014 immediate, then fixed in sequence."
  }
];
export {
  issue01BookEntries,
