...
const ShelfListsSection = ({ shelfSlug, favoritesCount, lists }) => {
  return /* @__PURE__ */ jsxs("section", { class: "flex flex-col gap-3", children: [
    ...
    /* @__PURE__ */ jsxs("div", { class: "grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { class: "flex size-16 shrink-0 items-center justify-center bg-surface text-xs text-on-surface-weak", children: "\u2665" }),
            /* @__PURE__ */ jsxs("div", { class: "min-w-0", children: [
              /* @__PURE__ */ jsx("p", { class: "font-medium text-on-surface-strong", children: "Favorites" }),
              /* @__PURE__ */ jsxs("p", { class: "text-xs text-on-surface-weak tabular-nums", children: [
                favoritesCount,
                " ",
                favoritesCount === 1 ? "book" : "books"
              ] })
            ] })
          ]
        }
      ...
      lists.map((list) => /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            ...
            ) : /* @__PURE__ */ jsx("div", { class: "flex size-full items-center justify-center text-xs text-on-surface-weak", children: "List" }) }),
            /* @__PURE__ */ jsxs("div", { class: "min-w-0", children: [
