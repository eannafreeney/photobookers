...
const ShelfSharingPanel = ({ user, suggestedSlug, message }) => {
  ...
  return /* @__PURE__ */ jsx(FeatureGuard, { flagName: "collectors", children: /* @__PURE__ */ jsxs("details", { class: "group rounded border border-outline bg-surface-alt", children: [
