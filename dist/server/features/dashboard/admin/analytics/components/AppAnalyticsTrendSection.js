...
const SERIES = [
  { key: "downloads", label: "Downloads", color: "#1d4ed8" },
  {
    key: "firstTimeDownloads",
    label: "First-time",
    color: "#047857"
  },
  { key: "redownloads", label: "Redownloads", color: "#b45309" }
];
const AppAnalyticsTrendSection = ({ data, dateRange }) => {
  const subtitle = data.usesDefaultRange ? "Last 30 days" : formatAnalyticsDateRangeLabel(dateRange);
  return /* @__PURE__ */ jsx(
    ChartBlock,
    {
      title: "Daily iOS downloads",
      subtitle,
...
const ChartBlock = ({
  ...
  return /* @__PURE__ */ jsxs("div", { class: "flex flex-col gap-4", children: [
    ...
    points.length === 0 ? /* @__PURE__ */ jsx("p", { class: "text-sm text-on-surface", children: "No download data for this period." }) : /* @__PURE__ */ jsxs("div", { class: "overflow-x-auto rounded-radius border border-outline bg-surface p-4 shadow-sm", children: [
      /* @__PURE__ */ jsxs(
        "svg",
        {
...
var AppAnalyticsTrendSection_default = AppAnalyticsTrendSection;
export {
  AppAnalyticsTrendSection_default as default
};
