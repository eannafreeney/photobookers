...
const NewsletterAnalyticsTrendSection = ({ data, dateRange }) => {
  const subtitle = data.usesDefaultRange ? "Last 30 days" : formatAnalyticsDateRangeLabel(dateRange);
  ...
  const polyline = points.map((point, index) => `${toX(index)},${toY(point.signups)}`).join(" ");
  return /* @__PURE__ */ jsxs("div", { class: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Daily newsletter signups" }),
      /* @__PURE__ */ jsx("p", { class: "text-sm text-on-surface", children: subtitle })
    ] }),
    points.length === 0 ? /* @__PURE__ */ jsx("p", { class: "text-sm text-on-surface", children: "No signup data for this period." }) : /* @__PURE__ */ jsxs("div", { class: "overflow-x-auto rounded-radius border border-outline bg-surface p-4 shadow-sm", children: [
      /* @__PURE__ */ jsxs(
        "svg",
        {
      ...
      /* @__PURE__ */ jsxs("div", { class: "mt-4 flex items-center gap-2 text-sm text-on-surface", children: [
        /* @__PURE__ */ jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsx("span", { children: "Signups" })
      ] })
    ] })
  ] });
};
...
var NewsletterAnalyticsTrendSection_default = NewsletterAnalyticsTrendSection;
export {
  NewsletterAnalyticsTrendSection_default as default
};
