...
function statsBlock(stats) {
  ...
  const topBookLine = stats.topBookTitle && stats.topBookViews > 0 ? `<li>Top book lately: <strong>${stats.topBookTitle}</strong> (${stats.topBookViews} views in the last 30 days)</li>` : "";
  return `
...
const generateClaimApprovalEmail = (claimUser, creator, stats) => {
