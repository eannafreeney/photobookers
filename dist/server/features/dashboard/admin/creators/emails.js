...
const buildUnverifiedCreatorBenefitsHtml = (profileUrl, claimLink) => `
...
`;
const generateWelcomeEmail = (creator, claimLink) => {
...
const generateWelcomeEmailForCreator = (creator, claimLink) => {
  const creatorName = creator.displayName;
  const profileUrl = `${siteUrl()}/creators/${creator.slug}`;
  return `
    <p>Hi ${creatorName},</p>
...
const generateInterviewInviteEmail = (params) => {
  return `
...
const generateInterviewInviteResendEmail = (params) => {
  return `
    <p>Hi ${params.creatorName},</p>
...
const generateBookApprovedEmail = (params) => {
  return `
    <p>Hi ${params.creatorName},</p>
...
const generateBookRejectedEmail = (params) => {
  return `
    <p>Hi ${params.creatorName},</p>
...
const generateBookFeedbackEmail = (params) => {
  return `
    <p>Hi ${params.creatorName},</p>
