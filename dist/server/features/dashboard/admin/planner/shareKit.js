...
function buildCreatorShareKitInstagramCaption(params) {
...
function buildCreatorShareKitEmailHtml(params) {
  const role = params.type === "artist" ? "Artist of the Week" : "Publisher of the Week";
...
function buildBotdShareKitInstagramCaption(params) {
  const intro = params.recipientType === "artist" ? `My book "${params.bookTitle}" is Book of the Day on ${PHOTOBOOKERS_IG} today.` : `"${params.bookTitle}" by ${params.artistName} is Book of the Day on ${PHOTOBOOKERS_IG} today.`;
...
function buildBotdShareKitEmailHtml(params) {
...
export {
  ...
  buildBotdShareKitInstagramCaption,
  buildCreatorShareKitEmailHtml,
  buildCreatorShareKitInstagramCaption,
  escapeHtml
};
