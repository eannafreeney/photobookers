...
import RandomPickButton from "./RandomPickButton.js";
...
const BOTDCard = ({ date, bookOfTheDay }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { class: "border-t border-outline pt-3", children: [
    ...
    bookOfTheDay?.book ? /* @__PURE__ */ jsx(
      BOTDCardContent,
      {
        dateKey,
        weekKey,
...
const BOTDCardContent = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { class: "flex items-start justify-between gap-3", children: [
      book.coverUrl && /* @__PURE__ */ jsx(Link, { href: `/books/${book.slug}`, children: /* @__PURE__ */ jsx(
        "img",
        {
          src: book.coverUrl,
          alt: book.title,
      ...
      /* @__PURE__ */ jsxs("div", { class: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsx(Link, { href: `/books/${book.slug}`, children: /* @__PURE__ */ jsx("p", { class: "text-sm font-semibold text-on-surface-strong line-clamp-2", children: book.title }) }),
