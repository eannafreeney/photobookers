...
const Checkbox = ({ label, name, required = false }) => {
  return /* @__PURE__ */ jsx("fieldset", { class: "grid mt-2 text-xs grid-cols-1 auto-rows-max", children: /* @__PURE__ */ jsxs(
    "label",
    {
      for: name,
      ...
      children: [
        /* @__PURE__ */ jsxs("span", { class: "relative flex items-center", children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              id: name,
