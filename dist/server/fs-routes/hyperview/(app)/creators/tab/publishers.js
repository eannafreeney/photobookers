...
const GET = createRoute(async (c) => {
  ...
  const loadMoreHref = `${baseUrl}/hyperview/creators/tab/publishers`;
  ...
  if (error) {
    return hv(
      /* @__PURE__ */ jsx(CreatorsListMessage, { children: /* @__PURE__ */ jsx(Text, { style: "featured-empty-hint", children: "Failed to load publishers." }) })
    );
  }
  ...
  if (currentPage === 1 && creators.length === 0) {
    return hv(
      /* @__PURE__ */ jsx(CreatorsListMessage, { children: /* @__PURE__ */ jsx(Text, { style: "featured-empty-hint", children: "No publishers found." }) })
    );
  }
