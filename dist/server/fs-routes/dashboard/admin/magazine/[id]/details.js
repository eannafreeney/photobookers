...
import { magazineDetailsFormSchema } from "../../../../../features/dashboard/admin/magazine/schema.js";
import { updateIssueDetails } from "../../../../../domain/magazine/mutations.js";
...
const POST = createRoute(
  ...
  async (c) => {
    ...
    const paragraphs = (form.editorsLetter ?? "").split(/\n\s*\n/).map((p) => p.trim()).filter(Boolean);
