...
import VerifiedCreatorsTable from "../../../../../features/dashboard/admin/analytics/components/VerifiedCreatorsTable.js";
...
const GET = createRoute(async (c) => {
  ...
  return c.html(
    /* @__PURE__ */ jsx(AppLayout, { title: "Verified creators", user, currentPath, children: /* @__PURE__ */ jsx(Page, { children: /* @__PURE__ */ jsx(Sidebar, { currentPath, children: /* @__PURE__ */ jsxs("div", { class: "flex flex-col gap-6", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
