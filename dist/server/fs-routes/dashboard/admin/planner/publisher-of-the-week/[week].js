...
import { deletePublisherOfTheWeekByWeekStart } from "../../../../../features/dashboard/admin/planner/services.js";
  ...
  async (c) => {
    ...
    return c.html(
      /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(Alert, { type: "success", message: "Publisher of the Week removed." }),
