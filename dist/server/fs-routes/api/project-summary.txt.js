...
} from "../../lib/projectSummary/generateProjectSummary.js";
const SUMMARY_CACHE = "public, max-age=3600";
function readCommittedSummary() {
  try {
...
const GET = createRoute(async (c) => {
  const body = readCommittedSummary() ?? generateProjectSummary({ rootDir: process.cwd() });
