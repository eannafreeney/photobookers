...
const GET = createRoute(async (c) => {
  ...
  const shareImage = botdEntries[0]?.book.coverUrl ?? artistOfTheWeek?.featuredImageUrl ?? publisherOfTheWeek?.featuredImageUrl ?? artistOfTheWeek?.creator.coverUrl ?? publisherOfTheWeek?.creator.coverUrl ?? void 0;
  if (!user) {
