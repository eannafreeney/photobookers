    ...
    return c.html(
      /* @__PURE__ */ jsx(
        AppLayout,
        {
          ...
          children: /* @__PURE__ */ jsx(Page, { children: /* @__PURE__ */ jsxs("div", { class: "flex flex-col gap-4", "x-data": "{ tab: 'favourites' }", children: [
            ...
            /* @__PURE__ */ jsx("div", { "x-show": "tab === 'lists'", "x-cloak": true, children: /* @__PURE__ */ jsx(
              ShelfListsSection,
              {
                shelfSlug: slug,
