...
import FairsTimeline from "../../../features/app/fairs/components/FairsTimeline.js";
...
const GET = createRoute(async (c) => {
  ...
  return c.html(
    /* @__PURE__ */ jsxs("div", { id: "fairs-fragment", children: [
      /* @__PURE__ */ jsx(SectionHeader, { kicker: "Days Out!", action: /* @__PURE__ */ jsx(ViewAllLink, { href: "/fairs" }), children: "Book Fairs" }),
      /* @__PURE__ */ jsx(FairsTimeline, { fairs: allFairs }),
