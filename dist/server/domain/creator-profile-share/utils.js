const CREATOR_PROFILE_SHARE_DAILY_LIMIT = 10;
function resolveCreatorProfileShareDailyLimit(override) {
  ...
  return Number.isNaN(parsed) || parsed <= 0 ? CREATOR_PROFILE_SHARE_DAILY_LIMIT : parsed;
}
export {
