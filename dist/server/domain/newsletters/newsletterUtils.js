...
const NEWSLETTER_TEST_WEEKDAY_UTC = 2;
...
function getNextNewsletterRange(referenceDate = /* @__PURE__ */ new Date()) {
...
function isNewsletterTestDay(referenceDate = /* @__PURE__ */ new Date()) {
  return toUtcStartOfDay(referenceDate).getUTCDay() === NEWSLETTER_TEST_WEEKDAY_UTC;
}
